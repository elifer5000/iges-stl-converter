...
BEGIN_MESSAGE_MAP(CIgesApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CIgesApp::OnAppAbout)
...
BOOL CIgesApp::InitInstance()
{
	...
	SetRegistryKey(_T("Elias Cohenca - Technion"));
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CIgesDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CIgesView));
	if (!pDocTemplate)
		return FALSE;
